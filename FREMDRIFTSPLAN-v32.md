...
**5. august 2026 · bygget på v31 av 1. august**

## 0. Om dette dokumentet

**Hva v32 er.** Den fullstendige, samlede fremdriftsplanen. v31 er malen: alle
51 seksjoner er med videre, ordrett. Det som er endret står som merkede blokker
der det hører hjemme, og som sju nye seksjoner (52–58) til slutt.
...
lansering (42), 60-minuttersmålet (43), Island utdypet (44), oversettelsesstrategi (45) og må-tillansering-rammeverket
(46).
...
Hva som var nytt i v28 (29. juni). Evaluering Del 4 ferdig. Full Ramsalt-eksport mottatt. Dropboxvideokartleggingen
...
### 0.4 Tidligere endringslogger (v24–v29, sammendrag)
...
v26→v27: Ramsalt fid→filsti løst. Full eksport bestilt. Dispatch/subagenter innarbeidet. Coworkoppdrag
A/B/C dokumentert.
...
## 4. Status akkurat nå (1. august 2026)
...
| Evaluering — grunnmodul + Fase 2 (Del 1–4) | Komplett |
...
| Resend Trinn B — steg 3b–3d (motor, e-poster, frontend) | NESTE OPPGAVE |
...
| Kontrakter / avtaler (startdato, pris, varighet, | HubSpot | HubSpot → nettside |
...
| P3 — etter lansering | Kontraktinfo fra HubSpot vises på skolekort på Min side | Planlagt |
...
Bli på Resend (ikke bytt til Brevo) — byttekostnad høyere enn GDPR-gevinsten. Resend er GDPRkompatibel,
...
- Mediebibliotek: alle godkjente bilder i Supabase Storage med metadata, søkbart, kobles til PDFgenerator.
...
i v30 (seksjon 46.4, spørsmål a) og er nå avgjort. Konsekvensen er at TL-hjulet og Periodeplanen
...
- Merk: nettverk→RA-autofyll fyller i dag tekst, ikke kursholder-kobling. Det er ingen fast RAdefault
ennå.
...
personvernhensyn — det er et konkret krav om utløpende videolenker (seksjon 32.6).
...
Nytt punkt til RLS-gjennomgangen (1. august): tabellen kurs_skole_mottaker gir anon både leseog
...
fallback). AI-agentesting: automatiserte testpersonas. Husk å bytte nettsted_url i innstillingertabellen
...
>
> Nye åpne punkter: når skal kortantallet fryses (åpent siden 15. juni)?
...
| Kursbagger / utstyrsbestilling | MULIG HULL — dekkes ikke av planen i dag, men er en RA-oppgave. Se seksjon 49. |
| Kursplanlegger | PILOT-KLAR. Demo-innhold og Trinn B-testspor slettes før pilot. |
| Resend Trinn B | PÅGÅR — steg 1, 2 og 3a ferdig. 3b–3d gjenstår. |
...
NYE SEKSJONER I v31 — kunnskapsgrunnlag mottatt 1. august
2026
Seksjonene 47–51 er nye i v31 og lagt til bakerst, i tråd med etablert praksis fra v28→v29 og
...
Alle tre trenger å vite hvem som endret hva og når. Beslutningen må derfor være tatt før Fase 3strukturen
...
Reposisjoner Trivselsleder fra «friminuttprogram» til «skolens verktøy for hele det daglige 60minutters
...
komme etter lansering» (46.2), men er samtidig en forutsetning for at piloten skal være selvgående
...
Fase 3-strukturen (den store byggejobben), design-fasen, og at importen er blokkert til Jons augusteksport
...
## 47. Edalio-kartlegging (NY) — samme stack, ti gjenbrukbare
...
| 2 | FULLTEKSTSØK fra dag én (Postgres FTS + pg_trgm) | Søk-mens-du-skriver. Edalios STØRSTE ANGER er at de manglet dette i starten |
...
### 49.2 Mulig hull i planen

Kursbagger og utstyrsbestilling er en RA-oppgave som ikke er dekket noe sted i fremdriftsplanen.
Det kan være bevisst (håndteres i Tripletex/manuelt), men det bør avklares — ikke oppdages ved
lansering.
...
var utdatert fordi sikkerhetsrettingen samme dag hadde forskjøvet fila. Alle
ti er rettet.
