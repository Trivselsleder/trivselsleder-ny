...
function KontaktBlokk({ tittel, navn, epost, telefon }) {
  ...
  return (
    <div>
      <p className="text-xs font-semibold text-[#B5560F] uppercase tracking-wide mb-1">{tittel}</p>
      <InfoRad label="Navn" verdi={navn} />
      <InfoRad label="E-post" verdi={epost && <a href={`mailto:${epost}`} className="text-[#B5560F] hover:underline">{epost}</a>} />
...
function NettverkOgKursBlokk({ skole, nettverksforslag }) {
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-gray-50 px-4 py-4 space-y-3">
      <p className="text-xs font-semibold text-[#B5560F] uppercase tracking-wide">Nettverk</p>
        ...
        <>
          ...
          <div className="flex items-center justify-between gap-2 pt-1">
            ...
            <button
              ...
              className="bg-[#FF7B31] text-gray-900 text-sm font-medium px-4 py-2 rounded-full hover:bg-[#e8641c] transition-colors disabled:opacity-50"
            >
    ...
    <div className="fixed inset-0 z-50 flex items-start justify-center bg-black/40 px-4 py-8 overflow-y-auto">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-2xl">
        ...
        <div className="px-6 py-5 space-y-5">
          ...
          <div>
            <p className="text-xs font-semibold text-[#B5560F] uppercase tracking-wide mb-1">Skole</p>
            ...
            <InfoRad label="Hjemmeside" verdi={p.hjemmeside && <a href={p.hjemmeside} target="_blank" rel="noreferrer" className="text-[#B5560F] hover:underline">{p.hjemmeside}</a>} />
          </div>

          <div>
            <p className="text-xs font-semibold text-[#B5560F] uppercase tracking-wide mb-1">Adresse</p>
          ...
          <div>
            <p className="text-xs font-semibold text-[#B5560F] uppercase tracking-wide mb-1">Faktura</p>
          ...
          {p.merknader && (
            <div>
              <p className="text-xs font-semibold text-[#B5560F] uppercase tracking-wide mb-1">Merknader</p>
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <a
                          ...
                          className="text-[#B5560F] hover:underline"
                        >
                          {p.rektor_epost}
                        </a>
                      </td>
