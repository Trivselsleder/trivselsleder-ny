        ...
        {!laster && !feil && (
          <>
            <div className="flex flex-wrap items-center gap-3 mb-5">
              ...
              <span className="text-sm px-3 py-1 rounded-lg bg-[#F47920]/10 text-[#F47920] font-medium">
                {totaltBelop} kr
              </span>
            </div>
                          ...
                          {r.kilde === 'Kurs' ? (
                            redigerId === r._id ? (
                              ...
                              <span className="inline-flex items-center gap-1.5 justify-end">
                                <span className={`font-semibold ${r.frosset ? 'text-gray-900' : 'text-[#F47920]'}`}>{r.antall}</span>
                                {r.frosset
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button type="button"
                      ...
                      className="text-xs text-[#F47920] hover:underline">+ Legg til trinn</button>
                  </div>
